      ...
      <table class="w-full border">
            ...
            <tbody>
                ...
                <tr class="border-t">
                  ...
                  <a href="{{ route('admin.loan-products.edit', $product) }}" class="bg-yellow-500 text-white px-2 py-1 rounded"> Edit
            </a>
            <form action="{{ route('admin.loan-products.destroy', $product) }}" method="POST">
                @csrf
                @method('DELETE')
