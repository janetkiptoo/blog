    ...
    <div class="bg-white p-6 rounded-lg shadow mb-6">
        <form method="GET" class="grid grid-cols-1 md:grid-cols-5 gap-4">
            ...
            <div class="md:col-span-4 flex items-end gap-3">
                <button type="submit" class="bg-primary-700 hover:bg-primary-500 text-white px-4 py-2 rounded"> Filter </button>
...
<td class="px-4 py-3 border text-center">
    @if ($loan->status === 'pending')
        <div class="flex justify-center gap-2">
            ...
            @csrf
            <button class="bg-primary-700 hover:bg-primary-500 text-white px-3 py-1 rounded text-sm">
                Disburse
            </button>
        </form>
