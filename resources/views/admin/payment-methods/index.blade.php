...
<a href="{{ route('admin.payment-methods.create') }}" class="bg-blue-600 text-white px-4 py-2 rounded"> 
    +Add Payment Method
</a>
</div>
    ...
    <tbody>
        ...
        <tr class="border-t" >
            ...
            <td class="p-2 space-x-2">
                <a href="{{ route('admin.payment-methods.edit', $method) }}" class="bg-blue-600 text-white px-4 py-2 rounded">Edit</a>
