    ...
    <div class="bg-white p-6 rounded shadow">
        ...
        <form action="{{ route('admin.loan-products.update', $loan_product) }}" method="POST" class="grid grid-cols-3 gap-4">
           ...
           <div>
            ...
            <div>
             <label for="min_loan_amount" class="block text-sm font-medium text-gray-700">Min loan amount</label>
            ...
            <div>
             <label for="max_loan_amount" class="block text-sm font-medium text-gray-700">max loan amount</label>
